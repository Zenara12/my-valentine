...
<template>
  ...
  <div v-if="view === 'celebration'" class="celebration fade-in">
    ...
    <!-- Avatar -->
    <div class="celebration__avatar" :style="{ backgroundImage: `url('${TEDDY_IMAGE_URL}')` }" />
  ...
  <div v-else class="app-wrapper">
    ...
    <main class="app-main">
      ...
      <div class="hero-circle floating">
        <div class="hero-circle__image" :style="{ backgroundImage: `url('${TEDDY_IMAGE_URL}')` }" />
      ...
      <!-- Buttons -->
      <div class="btn-group">
        <button class="btn-yes btn-press" :style="{ transform: `scale(${yesScale})` }" @click="handleYesClick">
          <span class="material-symbols-outlined">favorite</span>
          Yes!
        </button>

        <button class="btn-no btn-press" :style="{ transform: `scale(${noScale})` }" @click="handleNoClick">
          No
        </button>
      </div>
